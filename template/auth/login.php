...
<head>
    ...
    <title>login</title>
    <link rel="shortcut icon" href="http://localhost/icon" type="image/x-icon" />
...
<section class="container-fluid bg-auth-form d-flex justify-content-center align-items-center ">
    <section class="row bg-gradiant-green-blue">
        ...
        <section class="col-12 bg-white p-5 rounded">
            ...
            <form method="post" class="" action="http://localhost/check-login">
                <?php
                $httpReferer = isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : null;
                if($httpReferer == 'http://localhost/login'){?>
...
<script src="http://localhost/public/js/admin/bootstrap.min.js"></script>
<!-- MDB core JavaScript -->
<script src="http://localhost/public/js/admin/mdb.min.js"></script>

<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>

<script type="text/javascript">
<?php if($httpReferer == 'http://localhost/login'){?>
    swal({
        title: "Login Error!",
