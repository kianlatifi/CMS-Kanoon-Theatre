        ...
        <section class="intro intro-h-600px">
            ...
            <?php if(isset($articles[0])) {?>
                <section class="intro-2-3-col intro-h-100 position-relative h-md-300px">
                    <a href="http://localhost/show-article/<?php echo $articles[0]['id'] ; ?>">
                        <section class="intro-2-3-item img-bg intro-h-100" style="background: url(http://localhost/<?php echo $articles[0]['image'] ; ?>) no-repeat center; background-size: cover;"></section>
                ...
                <section class="intro-1-3-col intro-h-100">
                    ...
                    <section class="intro-1-3-item intro-h-50 position-relative h-md-300px">
                        <a href="http://localhost/show-article/<?php echo $articles[1]['id'] ; ?>">
                            <section class="img-bg intro-h-100" style="background: url(http://localhost/<?php echo $articles[1]['image'] ; ?>) no-repeat center; background-size: cover;"></section>
                            <section class="intro-item-caption">
                                <h3 class="caption-title">
                ...
                <?php if(isset($articles[2])) {?>
                    <section class="intro-1-3-item intro-h-50 position-relative h-md-300px">
                        <a href="http://localhost/show-article/<?php echo $articles[2]['id'] ; ?>">
                            <section class="img-bg intro-h-100" style="background: url(http://localhost/<?php echo $articles[2]['image'] ; ?>) no-repeat center; background-size: cover;"></section>
                            <section class="intro-item-caption">
                                <h3 class="caption-title">
            ...
            <section class="intro-row intro-h-1-3">
                ...
                <a href="http://localhost/show-article/<?php echo $articles[3]['id'] ; ?>">
                        <section class="img-bg intro-h-100" style="background: url(http://localhost/<?php echo $articles[3]['image'] ; ?>) no-repeat center; background-size: cover;"></section>
                        <section class="intro-item-caption">
                            <h3 class="caption-title">
                            <h3 class="caption-title">
                ...
                <section class="intro-1-3-col-item intro-h-100 position-relative h-md-300px">
                <a href="http://localhost/show-article/<?php echo $articles[4]['id'] ; ?>">
                        <section class="img-bg intro-h-100" style="background: url(http://localhost/<?php echo $articles[4]['image'] ; ?>) no-repeat center; background-size: cover;"></section>
                        <section class="intro-item-caption">
                            <h3 class="caption-title">
                ...
                <section class="intro-1-3-col-item intro-h-100 position-relative h-md-300px">
                <a href="http://localhost/show-article/<?php echo $articles[5]['id'] ; ?>">
                        <section class="img-bg intro-h-100" style="background: url(http://localhost/<?php echo $articles[5]['image'] ; ?>) no-repeat center; background-size: cover;"></section>
                        <section class="intro-item-caption">
                            <h3 class="caption-title">
