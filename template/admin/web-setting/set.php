...
<section class="row my-3">
    <section class="col-12">
        ...
        <form method="post" action="http://localhost/web-setting/store" enctype="multipart/form-data">
            ...
            <div class="form-group">
            <?php if($setting !=null){ ?>
                    <img style="width: 100px;" src="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/'.$setting['logo']; ?>" alt="" >
                <hr/>
                <?php } ?>
            ...
            <div class="form-group">
            <?php if($setting !=null){ ?>
                    <img style="width: 100px;" src="<?php echo 'http://'.$_SERVER['HTTP_HOST'].'/'.$setting['icon']; ?>" alt="" >
                <hr/>
                <?php } ?>
