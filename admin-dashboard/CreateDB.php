...
"CREATE TABLE `comments` (
            ...
            `status` enum('seen','unseen','approved') COLLATE utf8_persian_ci NOT NULL DEFAULT 'unseen',
            `created_at` datetime NOT NULL,
            `updated_at` datetime DEFAULT NULL,
            PRIMARY KEY (`id`),
            FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
"CREATE TABLE `menus`(
            ...
            `parent_id` int(11) COLLATE utf8_persian_ci,
            `created_at` datetime NOT NULL,
            `updated_at` datetime DEFAULT NULL,
            PRIMARY KEY (`id`),
    ...
    private $tableInitializes= array(
        ['table'=>'users', 'fields' => ['username','email','password','permission'], 'values'=>['Kian','Kian@gmail.com','$2y$10$B27QNZKLyQsWMETg3l5Bc.KJlFnHonRRfh.hBk9hfG3g6MTMzWAFK','admin']]
    );
    public function run()
    {
